...
const financialActions = [
  ...
  'SUPPLIER_MONTHLY_SETTLEMENT_PRECLOSED',
  'SUPPLIER_MONTHLY_SETTLEMENT_FINALIZED',
  'SUPPLIER_MONTHLY_SETTLEMENT_ADJUSTMENT_DETECTED',
] as const;
...
const actionLabels: Record<string, string> = {
  ...
  SUPPLIER_MONTHLY_SETTLEMENT_PRECLOSED: '生成供应商月末预结算',
  SUPPLIER_MONTHLY_SETTLEMENT_FINALIZED: '完成供应商月度封账',
  SUPPLIER_MONTHLY_SETTLEMENT_ADJUSTMENT_DETECTED: '发现供应商封账后调整',
  STUDIO_CREATED: '新增影楼',
